package com.ahmed.backend.config;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configureApiVersioning(ApiVersionConfigurer configurer) {
        ...
        // /api/users/{v}
        //   0   1     2
        // configurer.usePathSegment(2).addSupportedVersions("1.0" , "2.0");

//        configurer.useQueryParam("version").addSupportedVersions("1.0" , "2.0")
...
//               .setDefaultVersion("1.0");
        ...
        configurer.useMediaTypeParameter(
                MediaType.parseMediaType("application/vnd.ahmed+json"),"v")
