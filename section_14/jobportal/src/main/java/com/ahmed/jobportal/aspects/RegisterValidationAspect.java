...
import com.ahmed.jobportal.dto.RegisterRequestDto;
import com.ahmed.jobportal.entity.JobPortalUser;
import com.ahmed.jobportal.exception.RegistrationValidationException;
import com.ahmed.jobportal.repository.JobPortalUserRepository;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.ahmed.jobportal.auth.AuthController
        .registerUser(..))
        """)
